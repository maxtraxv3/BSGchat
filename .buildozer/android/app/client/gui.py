...
class ViewerWindow:
    """Separate popup window for video display only.

    Audio is handled by VoiceEngine — the viewer does NOT capture or play
    audio to avoid feedback loops with the mic.
    """
